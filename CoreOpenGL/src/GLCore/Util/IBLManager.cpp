...
{
	void IBLManager::prepare_PBR_IBL(int screenWidth, int screenHeight)
	{
		m_hdrTexture  = ImageLoader::loadHDR("assets/default/HDR/newport_loft.hdr");
